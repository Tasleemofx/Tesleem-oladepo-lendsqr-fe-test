...
import { FaRegHandshake, FaHandHoldingUsd, FaFan, FaScroll } from 'react-icons/fa'
    ...
    <div className="sidebar">
        ...
        <nav className="nav-items fcolumn">
          ...
          <FaHandHoldingUsd />
            ...
            <NavLink to="/" >
            <HiBuildingLibrary/>
              Savings Products</NavLink>
            <NavLink to="/" >
              <GiTwoCoins />
              Fees and Charges</NavLink>
            <NavLink to="/" >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-sliders2" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M10.5 1a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4H1.5a.5.5 0 0 1 0-1H10V1.5a.5.5 0 0 1 .5-.5ZM12 3.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Zm-6.5 2A.5.5 0 0 1 6 6v1.5h8.5a.5.5 0 0 1 0 1H6V10a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5ZM1 8a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2A.5.5 0 0 1 1 8Zm9.5 2a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V13H1.5a.5.5 0 0 1 0-1H10v-1.5a.5.5 0 0 1 .5-.5Zm1.5 2.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z" />
              ...
              Preferences</NavLink>
        <NavLink to="/"><GiTwoCoins />Fees and Pricing</NavLink>
            <NavLink to="/">
              <img src="../assets/images/Vector (2).png" alt="Audit"/>
              Audit Logs</NavLink>
        </nav>
    </div>
  )
